...
class MetalInferenceService:
    ...
    def _get_inference_device(self, requested_device: Optional[DeviceType]) -> torch.device:
    ...
    def _extract_best_move(self, output: torch.Tensor, board: List[List[int]]) -> Tuple[int, float]:
